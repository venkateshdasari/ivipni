...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/category-product-details/category-product-details.module').then( m => m.CategoryProductDetailsPageModule)
  },
  {
    path: 'category-product-details-info',
    loadChildren: () => import('./pages/category-product-details-info/category-product-details-info.module').then( m => m.CategoryProductDetailsInfoPageModule)
  },
  {
    path: 'chart',
  ...
  {
    path: 'my-password',
    loadChildren: () => import('./pages/my-password/my-password.module').then( m => m.MyPasswordPageModule)
  },
  {
    path: 'my-profile',
  ...
  {
    path: 'paymentremain',
    loadChildren: () => import('./pages/paymentremain/paymentremain.module').then( m => m.PaymentremainPageModule)
  },
  {
    path: 'paymentremaindetails',
    loadChildren: () => import('./pages/paymentremaindetails/paymentremaindetails.module').then( m => m.PaymentremaindetailsPageModule)
  },
  {
    path: 'payment-success-failure',
    loadChildren: () => import('./pages/payment-success-failure/payment-success-failure.module').then( m => m.PaymentSuccessFailurePageModule)
  },
  {
    path: 'paythank-you',
    loadChildren: () => import('./pages/paythank-you/paythank-you.module').then( m => m.PaythankYouPageModule)
  },
  {
    path: 'place-order',
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/product-sub-category/product-sub-category.module').then( m => m.ProductSubCategoryPageModule)
  },
  {
    path: 'registration',
  ...
  {
    path: 'reg-thankyou',
    loadChildren: () => import('./pages/reg-thankyou/reg-thankyou.module').then( m => m.RegThankyouPageModule)
  },
  {
    path: 'rootpage',
    loadChildren: () => import('./pages/rootpage/rootpage.module').then( m => m.RootpagePageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/seller-info-details/seller-info-details.module').then( m => m.SellerInfoDetailsPageModule)
  },
  {
    path: 'shoppingcart',
